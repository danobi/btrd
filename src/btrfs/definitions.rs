...
const BTRFS_ORPHAN_OBJECTID: u64 = 0u64.overflowing_sub(5).0;
const BTRFS_TREE_LOG_OBJECTID: u64 = 0u64.overflowing_sub(6).0;
const BTRFS_TREE_LOG_FIXUP_OBJECTID: u64 = 0u64.overflowing_sub(7).0;
const BTRFS_TREE_RELOC_OBJECTID: u64 = 0u64.overflowing_sub(8).0;
const BTRFS_DATA_RELOC_TREE_OBJECTID: u64 = 0u64.overflowing_sub(9).0;
